...
using Xamarin.Forms;
using BluetoothJoystick.Droid.CustomRenderers;
using BluetoothJoystick.Controls;
using BluetoothJoystick.Droid.JoystickAndroidCustomControl;

[assembly: ExportRenderer(typeof(JoystickControl), typeof(JoystickRenderer))]

namespace BluetoothJoystick.Droid.CustomRenderers
{
